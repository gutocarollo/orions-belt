...
Uso:
  python3 engine/lint/pending_index.py            # regenera docs/pending/index.md
  python3 engine/lint/pending_index.py --check    # nao escreve; falha se stale/podre
  python3 engine/lint/pending_index.py --json     # o backlog como dado
"""
    ...
    if args.check:
        if atual != novo:
            erros.append(
                ...
                "— rode `python3 engine/lint/pending_index.py`"
            )
        if erros:
