...
def check_docs_topology() -> tuple[list[str], bool]:
    ...
    # D5 cross-check: the project's own constitution should name every declared category,
    # so the declared topology and the human-readable doc do not silently drift apart.
