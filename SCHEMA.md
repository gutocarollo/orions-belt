...
| **Arqueólogo/mantenedor** | "Por que foi desenhado assim?" | [`docs/planning/`](docs/planning/) | História da construção (arquivo factual): plano consolidado + 8 relatórios de pesquisa + notas de fase. Não é produto — a verdade ATUAL de um componente é sempre o manual + o código. |
