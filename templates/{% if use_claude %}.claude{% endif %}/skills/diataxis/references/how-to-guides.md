...
## Canonical principles (from diataxis.fr/how-to-guides/)

- **Written from the perspective of the user, not of the machinery.** A how-to
  represents something a human needs to get done, defined by user need — not by
  operations the tool can perform.
- **About goals, projects and problems, not about tools.** Tools appear as
  incidental bit-players. A how-to may cut across multiple tools when joined
  by a human's project.
- **Real-world problems do not always offer themselves up to linear solutions.**
  Sequences in how-to guides sometimes **fork and overlap**, with multiple entry
  and exit points. The user often must apply judgement.
- **Address how the user thinks as well as what the user does.** Thinking and
  judgement are part of "actions" in a how-to.
- **Seek flow.** Pace and rhythm matter; well-formed how-tos feel like a helper
  who has the tool you were about to reach for, ready to place it in your hand.

Source: https://diataxis.fr/how-to-guides/#key-principles
...
Make the goal immediately clear. The canonical pattern is a 3-level distinction:
...
- **very bad:** _Application performance monitoring_ — maybe it's about _how_,
  but maybe it's about _whether_, or even just an explanation of _what_ it is.

Search engines reward clear titles too.
...
Source: https://diataxis.fr/how-to-guides/#pay-attention-to-naming
...
From diataxis.fr/how-to-guides/#the-language-of-how-to-guides:
...
| `Refer to the x reference guide for a full list of options.` | Link out; do not pollute with completeness. |

## Applied to food and cooking (canonical analogy)

The recipe is the canonical analogy for a how-to. From
diataxis.fr/how-to-guides/#applied-to-food-and-cooking:

- A recipe **clearly defines what will be achieved** and **addresses a specific
  question** (_How do I make…?_).
- It is **not the responsibility of a recipe to teach you how to cook.** A
  professional chef may still follow a recipe — even one they created themselves
  — to ensure they do it correctly.
- A recipe **requires basic competence**. Someone who has never cooked should
  not be expected to follow a recipe with success; a recipe is not a substitute
  for a cooking lesson.
- A person who expected a recipe and was given a cooking lesson would be
  disappointed and annoyed. Context and history of a dish are interesting, but
  not in the middle of trying to make it.

Hold this analogy when writing how-tos: assume competence, omit teaching,
exclude historical discussion. Address one specific question.
...
**Good:** "Set `windowMs: 900000` (15 minutes). [See all options →](#)"
