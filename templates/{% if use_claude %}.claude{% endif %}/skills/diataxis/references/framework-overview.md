...
The name "Diátaxis" comes from Ancient Greek δῐᾰ́τᾰξῐς — _dia_ ("across") and _taxis_ ("arrangement"). Source: https://diataxis.fr/
...
## Quality (Diátaxis canonical framework)

Diátaxis distinguishes **functional quality** from **deep quality**.

### Functional quality (objective, measured against the world)

Documentation must meet standards of **accuracy**, **completeness**,
**consistency**, **usefulness**, **precision**. Each is **independent** of the
others — documentation can be accurate without being complete; complete but
inaccurate and inconsistent; accurate, complete, consistent and also useless.

Functional quality is **measured** against the world, requires **discipline**,
and any failure is **readily apparent** to the user.

### Deep quality (subjective, assessed against the human)

Documentation can also exhibit:
...
These cannot be measured numerically; they must be **judged**. They are
**interdependent** — flow and anticipation are aspects of each other.
...
**Deep quality is conditional upon functional quality.** Documentation will
never be experienced as beautiful if it is inaccurate; will not feel anticipatory
if it is inconsistent.

### What Diátaxis can and cannot do

> **Diátaxis cannot address functional quality in documentation.** It is
> concerned only with certain aspects of deep quality.

Diátaxis's role with functional quality is **analytical** — it _exposes_ lapses
that were obscured before (e.g., aligning reference architecture with code
architecture makes documentation gaps visible).

Diátaxis's role with deep quality is **creative** — it directly serves _fit to
user needs_ and _flow_, by organising around needs and preventing rhythm
disruptions (e.g., explanation digressions interrupting how-to guides).

Diátaxis offers **principles, not a formula**. It does not bypass UX, UI or
visual design. Using Diátaxis lays down some **conditions for the possibility**
of deep quality — it does not guarantee it.
