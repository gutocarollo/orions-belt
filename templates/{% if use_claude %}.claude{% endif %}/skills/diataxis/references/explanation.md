...
The concept of _reflection_ is important. Reflection occurs **after** something
else, and **depends on** something else — yet at the same time brings something
new, shines a new light on the subject.

The perspective of explanation is **higher and wider** than that of the other
three types. It does not take the user's eye-level view (how-to) or a close-up
view of the machinery (reference). Its scope in each case is a topic — "an
area of knowledge" — bounded in a reasonable, meaningful way.

For the user, explanation joins things together. It answers: **"Can you tell
me about …?"**

It's documentation that makes sense to read **while away from the product
itself** (one could say, explanation is the only kind of documentation that
might make sense to read in the bath).

### The boundary problem

Explanation is open-ended: where does one start, where does one conclude?
Tutorials, how-tos, and reference are bounded by what the user needs to learn,
what task to achieve, or the scope of the machine itself. Explanation has none
of those. A practical technique: **use a real or imagined "why" question as a
prompt** to define a reasonable area, and be satisfied with that.

### Why explanation matters even though it feels less urgent

Without it, the practitioner's knowledge is "loose and fragmented and fragile,
and their exercise of it is _anxious_". Explanation **weaves** the web that
holds mastery together.
...
**User question:** "Why...?" or "How does this work?" or "What is...?" or
...
### Title pattern: "About <topic>"

Explanation guides are _about_ a topic in the sense that they are _around_ it.
Place an implicit (or explicit) _about_ in front of each title. Canonical
examples: _About user authentication_, _About database connection policies_.

Source: https://diataxis.fr/explanation/#talk-about-the-subject

### Canonical Language Patterns

From diataxis.fr/explanation/#the-language-of-explanation:

| Pattern | Function |
|---|---|
| `The reason for x is because historically, y…` | Explain. |
| `W is better than z, because…` | Offer judgements and even opinions. |
...
| `An x interacts with a y as follows: …` | Unfold the machinery's internal secrets. |

## Applied to food and cooking (canonical analogy)

Harold McGee's _On Food and Cooking_ (1984) is the canonical example of
explanatory writing. From diataxis.fr/explanation/#analogy-from-food-and-cooking:

- The book **doesn't teach** how to cook anything.
- It **doesn't contain recipes** (except as historical examples) and **isn't a
  work of reference**.
- It places food and cooking in **history, society, science and technology**.
- It explains _why_ we do what we do in the kitchen and how that has changed.
- It's not a book we read _while_ cooking. We read it when we want to
  **reflect** on cooking. It illuminates the subject by taking multiple
  different perspectives, shining light from different angles.
- After reading, our knowledge is richer and deeper. What we learned **may or
  may not be immediately applicable**, but it will change how we think about
  our craft, and affect our practice.

Aspire to this when writing explanation.
