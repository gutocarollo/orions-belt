...
| 🌐 | **Dual runtime core** | Gauntlet, the optional Council and core operational skills share sources across Claude Code and Codex; runtime-native capabilities remain explicit. |
...
- **[docs/manual/](docs/manual/README.md)** — the canonical product docs: 17 indexed chapters on
